...
#                                label=_(u'username (email)'))
    username = forms.EmailField(widget=forms.TextInput(attrs=dict(attrs_dict,
                                                               maxlength=75)),
                                label=_(u'username (email)'))
    email = forms.EmailField(widget=forms.TextInput(attrs=dict(attrs_dict,
                                                               maxlength=75)),
                             label=_(u'email address'))
    password1 = forms.CharField(widget=forms.PasswordInput(attrs=dict(attrs_dict, maxlenght=5), render_value=False),
                                label=_(u'password'))
    password2 = forms.CharField(widget=forms.PasswordInput(attrs=dict(attrs_dict, maxlenght=5), render_value=False),
                                label=_(u'password (again)'))
    #capthcha = forms.CharField(widget=forms.TextInput(attrs = attrs_dict))
